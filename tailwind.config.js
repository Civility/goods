	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				mainLight: '0px 0 20px 4px #F35CA4, inset 0 0 20px #F35CA4',
				secLight: '0px 0 20px 4px #C28BD2, inset 0 0 20px #C28BD2',
				someLight: '0px 0 20px 4px #7086AA, inset 0 0 20px #7086AA',
			},
